...
INSERT INTO coupons (user_id, name, percentage) VALUES
	(1, 'Sausage discount', 10),           -- 1
	(1, 'Bread super-sale', 50),           -- 2
	(2, 'Bread super-sale', 40),           -- 3
	(2, '20% off from EVERYTHING!', 20),   -- 4
	(1, '1 product for FREE!', 100);       -- 5
