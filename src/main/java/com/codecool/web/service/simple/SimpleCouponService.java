...
public final class SimpleCouponService implements CouponService {
    ...
    @Override
    public List<Coupon> getCouponByUser(User user) throws SQLException, ServiceException {
        try {
    ...
    @Override
    public List<Coupon> getRelatedCoupons(User user, Shop shop) throws SQLException, ServiceException {
        try {
            return couponDao.findCouponsByShop(user, shop);
        } catch (IllegalArgumentException ex) {
            throw new ServiceException(ex.getMessage());
        }
    }
    ...
    @Override
    public Coupon addCoupon(String name, String percentage, User user) throws SQLException, ServiceException {
        try {
            return couponDao.add(name, Integer.parseInt(percentage), user);
        } catch (NumberFormatException ex) {
    ...
    @Override
    public void addCouponToShops(User user, String couponId, String... shopIds) throws SQLException, ServiceException {
